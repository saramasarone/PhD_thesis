...
from utils import load_model_dict, save_model_dict
...
def cal_feat_imp(data_folder, model_folder, view_list, num_class):
    ...
    print("creating a list for the features")
    featname_list = []
    for v in view_list:
    ...
    print("Initialising the model dict")
...
def summarize_imp_feat(featimp_list_list, topn=50):  #30
    ...
    #save to file
    #pd.DataFrame(df_featimp_top).to_csv('top_features_.csv')
